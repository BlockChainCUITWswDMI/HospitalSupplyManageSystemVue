<template>
    <div class="hospital">
        ...
        <div class="hospital-header">
            ...
            <!-- form搜索区 -->
            <el-form :inline="true" :model="hospitalform">
                <el-form-item>
                    <el-input placeholder="请输入医院姓名" v-model="hospitalform.hospitalname"></el-input>
                </el-form-item>
                <el-form-item>
...
<script>
    import { addHospital, updateHospital, getAllHospital } from '../api/hospital.js'
    export default {
        data(){
            return {
                dialogVisible : false,
